        ...
        <div className='col-span-4 w-full border-1  border-neutral-300 pl-5'>
            <div className="w-full space-y-3 text-left">
                ...
                <ul className="w-full list-disc list-outside space-y-2.5 px-4">
                    ...
                    <li className="text-sm text-neutral-500 font-normal">
                        Passenger must keep their tickets until the journey ends; otherwise, they will need to purchase a new one.
                    </li>
                    <li className="text-sm text-neutral-500 font-normal">
                    ...
                    <li className="text-sm text-neutral-500 font-normal">
                        Passenger must arrive at the boarding point 30 minutes before the departure time. The company is not responsible for missed buses due to late arrivals.
                    </li>
                </ul>
            </div>
        </div>
