...
function Page() {
  ...
  //const [dbbus, setdbBus] = useState([]);                 //Loading All Buses
  const [dbItem, setdbItem] = useState({});                 //Specific Bus
  // const [dbSeats, setDbSeats] = useState([]);            //Loading All Seats
  const [LoadedSeats, setLoadedSeats] = useState({});       //Specific Seats
  // ==================================================
  ...
  useEffect(() => {
    ...
    Loadingbuses(); // Wait for Loadingbuses to complete
    // alert("Bus is laoded")
    LoadingSpecificBus(); // Then execute LoadingSpecificBus
    // alert("Specific Bus is laoded")
    LoadingSeats(); // Wait for LoadingSeats to complete
    // alert("Seats is laoded")
    LoadingSpecificSeats(); // Finally execute LoadingSpecificSeats
    // alert("Specific Seats is laoded")
    // _________________________________________________________
  ...
  return (
    ...
    <section className=" text-gray-600 body-font overflow-hidden flex flex-col justify-center items-center">
      ...
      <div className=" border-1 border-red-500 container px-2 py-2 mx-auto flex justify-center items-center">

        <div className="border-1 border-green-500 lg:w-auto mx-auto flex flex-wrap md:flex-nowrap justify-center items-center">
          ...
          <div className=" border-1 w-auto md:w-[40%]  border-blue-500 flex flex-col justify-center items-center">
            ...
            <div>
              <Image
                ...
                width={600}
                height={350}
                className="border-1 border-black md:w-[600px] md:h-[400px] w-[400px] rounded-[5px] shadow-sm"
              />
            </div>
            {/* __________________________________________  */}

            <div className="border-1 border-black py-4 px-2 md:mt-9 flex justify-between">
          ...
          {/* ===============================================[ LEFT ]================================================================== */}
          <div className=" border-1 border-purple-500 w-full lg:w-1/2 lg:pl-4 lg:py-6 mt-6 lg:mt-0">
            {/* ----------------------------------- */}
            ...
            {/* ========================================= [ Seat Box ] ========================================================= */}
            <div className=" border-1  overflow-x-scroll border-blue-500 w-full grid grid-cols-5 gap-10 ">

              <div className="col-span-3 border-1 w-[735px] flex items-center justify-center shadow-sm rounded-xl p-0">


                <div className=" w-full space-y-7  border-2 border-gray-300 p-[40px]">
                  ...
                  <div className="flex items-stretch gap-x-1.5  w-full">
                    ...
                    {/* seat row */}
                    <div className="flex flex-col items-center border-l-2 border-dashed  ml-[-300px] md:ml-[-300px]">

                      <div className="flex-1 space-y-1">
                        {/* first row */}
                        <div className="w-auto md:w-[40vw] h-auto grid grid-cols-9 gap-x-5">
                          ...
                          {Object.entries(LoadedSeats)
                            ...
                            .map(([key, value], index) => (
                              <div
                                ...
                                className={`m-3 flex items-center justify-start cursor-pointer w-[70px] h-[50px] ${getSeatName(value)} ${value === "true" && selectedSeatColor[key] ? "text-yellow-600 cursor-not-allowed" : ""
                                  }`}
                              >
                        ...
                        {/* third row */}
                        <div className="w-auto md:w-[40vw] h-auto grid grid-cols-10 gap-x-5">
            ...
            <div className="flex ml-[-190px] md:ml-[105px] w-[500px]">
              <button onClick={() => setSlugBusId(slug)} className="mt-2 flex ml-auto text-white border-2 border-red-600 bg-red-600 hover:text-red-600 font-bold transition-all duration-300 hover:bg-transparent py-2 px-6 rounded-sm">
                <p
                  onClick={() => {
                    ...
                    if (seatCount == 0) {
                      ...
                      Swal.fire({
                        title: 'Warning!',
                        text: 'Select atleast one seat to continue',
                        icon: 'warning',
                        confirmButtonText: 'OK',
                      });
                      ...
                      route.push(`/pages/buses/${slug}/${dbItem.Bid}`)
                    }
      ...
      <div className="border-1 border-black w-full text-center flex items-center justify-center gap-6 flex-col mt-[10px]">
        <ToggleButton buttonText={"See Bus Details"} buttonTextHidden={"Hide Bus Deatils"}>
          <div className="w-full space-y-10">
            ...
            <div className="w-full grid grid-cols-5 md:grid-cols-7 gap-20">
