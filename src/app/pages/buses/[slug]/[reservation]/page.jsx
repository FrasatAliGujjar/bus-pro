...
const Page = () => {
    ...
    return (
        ...
        <div className="w-full border-1 bg-gray-50 flex flex-wrap md:flex-nowrap items-start justify-center h-auto p-[50px] mt-[20px] ">




            <div className="w-[100%] md:w-[50%] bg-white border-gray-300 border-2 rounded-lg p-8 pb-10 space-y-8 flex flex-col">
                ...
                {/* Form */}
                <form className="space-y-6 h-[100vh] flex flex-col justify-between" onSubmit={handleAddPassenger}>
                    {/* Full Name */}
            ...
            <div className="w-full mt-16 md:mt-0 border-2 md:w-[50%] h-[450px] md:h-screen rounded-sm ml-0 md:ml-[20px] flex justify-center p-[20px]">
                <div className="flex md:w-[100%] w-[500px] flex-col justify-center items-start col-span-2 border-1 rounded-sm  h-fit">
                    <h1 className="text-center font-bold w-full text-2xl text-red-600">Your Ticket Reservation Status</h1>


                    <div className="hidden w-full space-y-2 md:flex flex-col justify-center items-center p-[20px] mb-[20px]">
                    ...
                    <div className="w-full">
                        <div className="w-full flex flex-col items-start justify-center mb-[10px]">
                            <h1 className="text-neutral-600 font-bold my-5">
                                Bus Deatils
                            </h1>
                            ...
                            {/* //only show on mobile acreen ecause remove other design */}
                            <div className='md:hidden'>
                                {/* --------------------------------------- */}
                                <div className="w-full flex items-start justify-between ">
                                    <p className="text-neutral-500 font-bold mr-5">
                                        Bus Name
                                    </p>
                                    <p>
                                        {dbItem.busname}
